...
function pioche(c) {
    if (arraypioche.length >0) {
        document.getElementById("hand").appendChild(arraypioche[0].html);
        arrayplayers[c].domi.push(arraypioche[0]);
        arraypioche.splice(0, 1);
    }

    else {
        alert("La pioche est vide");
    }
    document.getElementById("pioche").removeEventListener('click', pioche);
    setTimeout(playerswitch, 2000);
}
...
function highlight(pla) {
     ...
     arrayplayers[pla].playerhtml.style.color = "orange";
}

function stophighlight(pla) {
    arrayplayers[pla].playerhtml.style.borderColor = "transparent";
    arrayplayers[pla].playerhtml.style.color = "transparent";
}
...
function playing() {
    ...
    function checkplayabledominos(dom, p) {

        if (dom.tuilebottom == arrayboard[0].tuilebottom || dom.tuiletop == arrayboard[0].tuilebottom || dom.tuilebottom == arrayboard[0].tuiletop || dom.tuiletop == arrayboard[0].tuiletop || dom.tuilebottom == arrayboard[arrayboard.length -1].tuilebottom || dom.tuiletop == arrayboard[arrayboard.length -1].tuilebottom || dom.tuilebottom == arrayboard[arrayboard.length -1].tuiletop || dom.tuiletop == arrayboard[arrayboard.length -1].tuiletop)
        { 
        dom.html.addEventListener('click', checkredborder);
        }

        function checkredborder() {
    
            if(arrayboard.length === 1) {
                var matcharray = [arrayboard[0]];
            }
            else if (arrayboard.length === 0) {
                return;
            }
            else {
                var matcharray = [arrayboard[0], arrayboard[arrayboard.length -1]];
            }
            currentplayer.forEach(function () {
                dom.html.removeEventListener('click', checkredborder);
            });
            matcharray.forEach(addredborder);

            function addredborder(match) {
                ...
                function selection(match) {
                    ...
                    function greenselection() {
                        ...
                        if (matcharray.length === 1) {
                            ...
                            matcharray[0].html.removeEventListener('dblclick', greenselection);
                            matcharray[1].html.removeEventListener('dblclick', greenselection);
                            if (matcharray[0].html.style.borderColor === "rgb(255, 0, 0)") {
                                matcharray[0].html.style.borderColor = "transparent";
                            }
                            else {
                                matcharray[1].html.style.borderColor = "transparent";
                            }
                        }
                        placement(selected); 
                        ...
                        function placement() {
                            ...
                            // B top = A bot
                            if (selected.tuiletop === dom.tuilebottom) { 
                                if (selected.html.style.transform === "rotate(-90deg)") {
                                    
                                    if (selected === arrayboard[0]) {
                                    ...
                                    currentplayer.splice(p,1);
                                    document.getElementById("boardgame").appendChild(dom.html);
                                    window.addEventListener('keydown',function choice(event) {
                                        switch(event.key) {
                                            case "ArrowUp":
                                            dom.html.name = "dM";
                                            break;
                                ...
                                if (selected.html.style.transform === "") {
                                ...
                                if (selected.html.style.transform === "rotate(180deg)") {
                        ...
                        // B top = A top
                            else if (selected.tuiletop === dom.tuiletop) {
                                if (selected.html.style.transform === "rotate(-90deg)") {
                        ...
                        // B bot = A bot
                            else if (selected.tuilebottom === dom.tuilebottom) {
                                if (selected.html.style.transform === "rotate(-90deg)") {
                        ...
                        //  B bot = A top
                            else if (selected.tuilebottom === dom.tuiletop) {
                                if (selected.html.style.transform === "rotate(-90deg)") {
                            ...
                            function pose() {
                                var dominoname = dom.html.name;
                                var selectedtop = selected.html.style.top;
                                var selectedleft = selected.html.style.left;
                                var xd = parseInt(selectedleft, 10);
                                var yd = parseInt(selectedtop, 10);
                                ...
                                switch (dominoname) {
                                    case "dA":
                                       dom.html.style.top = +topminus4+'rem';
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +xd+'rem';
                                        break;
                                    case "dA180":
                                       dom.html.style.top = +topminus4+'rem';
                                       dom.html.style.left = +xd+'rem';
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.transform = 'rotate(' + uturn + 'deg)';
                                        break;
                                    case "dE":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.top = +topplus4+'rem';
                                       dom.html.style.left = +xd+'rem';
                                        break;
                                    case "dE180":
                                       dom.html.style.position = 'absolute';
                                    ...
                                    case "dB":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.top = +topminus3+'rem';
                                       dom.html.style.left = +leftminus1+'rem';
                                       dom.html.style.transform = 'rotate(' + rotminus + 'deg)';
                                        break;
                                    case "dB180":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.top = +topminus3+'rem';
                                       dom.html.style.left = +leftminus1+'rem';
                                       dom.html.style.transform = 'rotate(' + rotplus + 'deg)';
                                        break;
                                    case "dF":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.top = +topplus3+'rem';
                                       dom.html.style.left = +leftminus1+'rem';
                                       dom.html.style.transform = 'rotate(' + rotminus + 'deg)';
                                        break;
                                    case "dF180":
                                    ...
                                    case "dD":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.top = +topminus3+'rem';
                                       dom.html.style.left = +leftplus1+'rem';
                                       dom.html.style.transform = 'rotate(' + rotplus + 'deg)';
                                        break;
                                    case "dD180":
                                       dom.html.style.position = 'absolute';
                                    ...
                                    case "dK":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftminus4+'rem';
                                       dom.html.style.top = +yd+'rem';
                                       dom.html.style.transform = 'rotate(' + rotplus + 'deg)';
                                        break;
                                    case "dK180":
                                       dom.html.style.position = 'absolute';
                                    ...
                                    case "dL":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftplus4+'rem';
                                       dom.html.style.top = +yd+'rem';
                                       dom.html.style.transform = 'rotate(' + rotplus + 'deg)';
                                        break;
                                    case "dL180":
                                    ...
                                    case "dM":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftminus3+'rem';
                                       dom.html.style.top = +topminus1+'rem';
                                        break;
                                    case "dM180":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftminus3+'rem';
                                    ...
                                    case "dN":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftplus3+'rem';
                                       dom.html.style.top = +topminus1+'rem';            
                                        break;
                                    case "dN180":
                                       dom.html.style.position = 'absolute';
                                    ...
                                    case "dO":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftminus3+'rem';
                                       dom.html.style.top = +topplus1+'rem';            
                                        break;
                                    case "dO180":
                                       dom.html.style.position = 'absolute';
                                       dom.html.style.left = +leftminus3+'rem';
